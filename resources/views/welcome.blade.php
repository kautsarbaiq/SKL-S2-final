...
<head>
    ...
    <title>MyNotepad - Catatan Pribadi Anda</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('notes.index') }}">{{ __('Catatan Saya') }}</a>
                            </li>
        ...
        <section class="hero-section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h1 class="display-4 fw-bold mb-4">Catat Semua Ide Anda</h1>
                        <p class="lead mb-4">MyNotepad adalah aplikasi catatan pribadi yang membantu Anda menyimpan dan
                            mengelola ide, tugas, dan pemikiran penting Anda dengan aman.</p>
                        <div class="d-flex gap-3">
                            ...
                            @else
                                <a href="{{ route('notes.index') }}" class="btn btn-light btn-lg">Catatan Saya</a>
                            @endguest
                        </div>
                    </div>
                    <div class="col-md-6 d-none d-md-block">
                        <img src="https://placehold.co/600x400/4a6cf7/white?text=MyNotepad" alt="MyNotepad"
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="feature-box">
                            ...
                            <p>Setiap catatan hanya bisa diakses oleh pemiliknya. Privasi Anda adalah prioritas kami.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box">
                            ...
                            <p>Antarmuka yang sederhana dan intuitif memudahkan Anda membuat dan mengedit catatan.</p>
                        </div>
                    </div>
                    <!-- Styles / Scripts -->
                        ...
                        <div
                            ...
                            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                                <div
                                    ...
                                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Laravel has an incredibly rich
